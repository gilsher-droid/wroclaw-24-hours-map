(function () {
  ...
  const key = "wroc-love-consent-v1";
  const maxAge = 180 * 24 * 60 * 60 * 1000;
  const copy = {
    he: { title: "בחירת פרטיות", intro: "נשתמש ב־Google Analytics למדידת שימוש באתר וב־Meta Pixel למדידת פעילות שמגיעה מפרסום, רק אם תבחרו לאשר. האתר פועל גם בלי מעקב.", analytics: "מדידת שימוש (Google Analytics)", marketing: "מדידת פרסום (Meta Pixel)", accept: "אישור הכול", reject: "דחיית הכול", customize: "התאמה אישית", save: "שמירת הבחירה", settings: "הגדרות פרטיות", policy: "מדיניות פרטיות", close: "סגירה" },
    en: { title: "Privacy choices", intro: "We use Google Analytics to measure site usage and Meta Pixel to measure activity from ads only if you choose to allow them. The site works without tracking.", analytics: "Usage analytics (Google Analytics)", marketing: "Ad measurement (Meta Pixel)", accept: "Accept all", reject: "Reject all", customize: "Customize", save: "Save choices", settings: "Privacy settings", policy: "Privacy notice", close: "Close" },
    pl: { title: "Wybór prywatności", intro: "Używamy Google Analytics do pomiaru korzystania z witryny i Meta Pixel do pomiaru ruchu z reklam tylko za Twoją zgodą. Strona działa bez śledzenia.", analytics: "Statystyki (Google Analytics)", marketing: "Pomiar reklam (Meta Pixel)", accept: "Akceptuj wszystkie", reject: "Odrzuć wszystkie", customize: "Dostosuj", save: "Zapisz wybór", settings: "Ustawienia prywatności", policy: "Informacja o prywatności", close: "Zamknij" },
    de: { title: "Datenschutzauswahl", intro: "Wir nutzen Google Analytics für die Website-Nutzung und Meta Pixel für die Messung von Anzeigen nur mit Ihrer Einwilligung. Die Website funktioniert auch ohne Tracking.", analytics: "Nutzungsanalyse (Google Analytics)", marketing: "Werbemessung (Meta Pixel)", accept: "Alle akzeptieren", reject: "Alle ablehnen", customize: "Anpassen", save: "Auswahl speichern", settings: "Datenschutzeinstellungen", policy: "Datenschutzhinweis", close: "Schließen" },
    cs: { title: "Volby soukromí", intro: "Google Analytics používáme k měření používání webu a Meta Pixel k měření návštěv z reklam pouze s vaším souhlasem. Web funguje i bez sledování.", analytics: "Analýza návštěvnosti (Google Analytics)", marketing: "Měření reklam (Meta Pixel)", accept: "Přijmout vše", reject: "Odmítnout vše", customize: "Přizpůsobit", save: "Uložit volbu", settings: "Nastavení soukromí", policy: "Ochrana soukromí", close: "Zavřít" },
  };
  ...
  function translate() {
    ...
    panel.querySelector("p").textContent = t.intro;
  ...
  function save(next) {
    choice = { analytics: next.analytics, marketing: next.marketing, at: Date.now() };
