(function () {
  ...
  const productLinks = {
    he: ["24 שעות בוורוצלב", "וורוצלב – המסלול המלא ל־4 ימים", "וורוצלב בכריסמס – מסלול רגוע ל־3 ימים", "לאכול, לשתות, לקנות ולישון בוורוצלב", "טיולים בשלזיה התחתית", "ההרפתקה התרבותית בוורוצלב"],
    en: ["24 Hours in Wrocław", "Four Days in Wrocław", "Christmas in Wrocław", "Eat, drink, shop and stay", "Lower Silesia excursions", "The cultural adventure in Wrocław"],
    pl: ["24 godziny we Wrocławiu", "Cztery dni we Wrocławiu", "Boże Narodzenie we Wrocławiu", "Jedzenie, napoje, zakupy i noclegi", "Wycieczki po Dolnym Śląsku", "Kulturalna przygoda we Wrocławiu"],
    de: ["24 Stunden in Wrocław", "Vier Tage in Wrocław", "Weihnachten in Wrocław", "Essen, Trinken, Einkaufen und Übernachten", "Ausflüge in Niederschlesien", "Das Kulturabenteuer in Wrocław"],
    cs: ["24 hodin ve Vratislavi", "Čtyři dny ve Vratislavi", "Vánoce ve Vratislavi", "Jídlo, pití, nákupy a ubytování", "Výlety po Dolním Slezsku", "Kulturní dobrodružství ve Vratislavi"]
  };
