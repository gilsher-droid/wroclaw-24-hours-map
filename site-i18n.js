(() => {
  ...
  const excursionProductTranslations = {
    ...
    de: {
      ...
      "טיולים חדשים מתווספים בהדרגה.": "Nach und nach kommen neue Ausflüge hinzu.", "הבסיס למוצר כבר פתוח. הטיול הראשון יופיע כאן לאחר השלמת התוכן.": "Die Produktbasis ist jetzt verfügbar. Der erste Ausflug erscheint hier, sobald die Inhalte fertig sind.", "הטיול הראשון כבר פתוח.": "Der erste Ausflug ist jetzt verfügbar.", "טירת קשונז׳ ושווידניצה — יום מלא של טירה, היסטוריה ואתר מורשת.": "Schloss Książ und Świdnica — ein ganzer Tag voller Schloss, Geschichte und Kulturerbe.", "פתחו את המוצר": "Produkt öffnen"
    },
    cs: {
      ...
      "טיולים חדשים מתווספים בהדרגה.": "Postupně přidáváme nové výlety.", "הבסיס למוצר כבר פתוח. הטיול הראשון יופיע כאן לאחר השלמת התוכן.": "Základ produktu je nyní dostupný. První výlet se zde objeví po dokončení obsahu.", "הטיול הראשון כבר פתוח.": "První výlet je nyní otevřený.", "טירת קשונז׳ ושווידניצה — יום מלא של טירה, היסטוריה ואתר מורשת.": "Zámek Książ a Svídnice — celý den plný zámku, historie a dědictví.", "פתחו את המוצר": "Otevřít produkt"
    }
  };
