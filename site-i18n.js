(() => {
  ...
  const lifestyleTranslations = {
    en: {
      ...
      "לקנות": "Shop", "מרכזי קניות": "Shopping centres", "מ־Westfield Wroclavia ו־Renoma ועד האאוטלט ומרכזים מקומיים.": "From Westfield Wroclavia and Renoma to the outlet and local centres.",
    ...
    pl: {
      ...
      "לקנות": "Zakupy", "מרכזי קניות": "Centra handlowe", "מ־Westfield Wroclavia ו־Renoma ועד האאוטלט ומרכזים מקומיים.": "Od Westfield Wroclavia i Renomy po outlet i lokalne centra.",
    ...
    de: {
      ...
      "לקנות": "Einkaufen", "מרכזי קניות": "Einkaufszentren", "מ־Westfield Wroclavia ו־Renoma ועד האאוטלט ומרכזים מקומיים.": "Von Westfield Wroclavia und Renoma bis zum Outlet und lokalen Zentren.",
    ...
    cs: {
      ...
      "לקנות": "Nakupovat", "מרכזי קניות": "Nákupní centra", "מ־Westfield Wroclavia ו־Renoma ועד האאוטלט ומרכזים מקומיים.": "Od Westfield Wroclavia a Renomy po outlet a místní centra.",
  ...
  const phaseOneTranslations = {
    en: {
      ...
      "פשוט מהבחירה ועד הטיול": "Simple from choosing to exploring", "איך זה עובד?": "How does it work?", "בוחרים מסלול": "Choose a route", "מוצאים את המפה שמתאימה לסגנון ולמשך הטיול.": "Find the map that suits your travel style and trip length.",
    ...
    pl: {
      ...
      "פשוט מהבחירה ועד הטיול": "Prosto od wyboru do zwiedzania", "איך זה עובד?": "Jak to działa?", "בוחרים מסלול": "Wybierz trasę", "מוצאים את המפה שמתאימה לסגנון ולמשך הטיול.": "Znajdź mapę dopasowaną do stylu i długości podróży.",
    ...
    de: {
      ...
      "פשוט מהבחירה ועד הטיול": "Einfach von der Auswahl bis zur Entdeckung", "איך זה עובד?": "Wie funktioniert es?", "בוחרים מסלול": "Route wählen", "מוצאים את המפה שמתאימה לסגנון ולמשך הטיול.": "Finden Sie die Karte, die zu Ihrem Reisestil und Ihrer Reisedauer passt.",
    ...
    cs: {
      ...
      "פשוט מהבחירה ועד הטיול": "Jednoduše od výběru k objevování", "איך זה עובד?": "Jak to funguje?", "בוחרים מסלול": "Vyberte trasu", "מוצאים את המפה שמתאימה לסגנון ולמשך הטיול.": "Najděte mapu, která odpovídá stylu a délce vaší cesty.",
