(function () {
  ...
  const content = {
    en: {
      ...
      choice: "Your choice",
      choiceText: "The site works without analytics or advertising measurement. On your first visit, you can accept all, reject all, or choose each purpose separately. You can change or withdraw your choice at any time using the Privacy settings button on any site page. We store the choice on your device for up to 180 days.",
    ...
    he: {
      ...
      choice: "הבחירה שלכם",
      choiceText: "האתר פועל גם ללא מדידה אנליטית או מדידת פרסום. בכניסה הראשונה אפשר לאשר הכול, לדחות הכול או לבחור בנפרד בכל מטרה. ניתן לשנות או לבטל את הבחירה בכל עת דרך כפתור הגדרות הפרטיות בכל עמוד באתר. הבחירה נשמרת במכשיר עד 180 ימים.",
      ...
      marketingText: "בהסכמה נפרדת לשיווק, Meta Pixel מודד צפיות בדפים ובמוצרי מפה כדי להבין תנועה ממודעות Facebook ו־Instagram. Meta עשויה לקבל מידע טכני כגון נתוני דפדפן ורשת ולהגדיר עוגיות. האתר אינו שולח אירועי רכישה או ליד. הפיקסל לא נטען לפני הסכמה לשיווק.",
    ...
    pl: {
      ...
      choice: "Twój wybór", choiceText: "Strona działa bez analityki i pomiaru reklam. Przy pierwszej wizycie możesz zaakceptować wszystko, odrzucić wszystko albo wybrać każdą kategorię osobno. Zgodę możesz zmienić lub wycofać w dowolnej chwili przyciskiem Ustawienia prywatności na każdej stronie. Wybór przechowujemy na Twoim urządzeniu do 180 dni.",
    ...
    de: {
      ...
      choice: "Ihre Wahl", choiceText: "Die Website funktioniert ohne Analyse- oder Werbemessung. Beim ersten Besuch können Sie alles akzeptieren, alles ablehnen oder die Zwecke getrennt wählen. Über die Schaltfläche Datenschutzeinstellungen auf jeder Seite können Sie Ihre Wahl jederzeit ändern oder widerrufen. Die Wahl wird bis zu 180 Tage auf Ihrem Gerät gespeichert.",
      ...
      marketing: "Werbemessung", marketingText: "Mit gesonderter Marketing-Einwilligung misst Meta Pixel Seiten- und Kartenproduktaufrufe, um Zugriffe über Facebook- und Instagram-Anzeigen auszuwerten. Meta kann technische Browser- und Netzwerkdaten erhalten und Cookies setzen. Die Website sendet keine Purchase- oder Lead-Ereignisse. Vor der Marketing-Einwilligung wird Meta Pixel nicht geladen.",
    ...
    cs: {
      ...
      choice: "Vaše volba", choiceText: "Web funguje bez analytiky a měření reklam. Při první návštěvě můžete vše přijmout, vše odmítnout nebo vybrat každý účel zvlášť. Souhlas lze kdykoli změnit nebo odvolat tlačítkem Nastavení soukromí na každé stránce. Volba se ukládá ve vašem zařízení až na 180 dní.",
      ...
      marketing: "Měření reklam", marketingText: "S odděleným marketingovým souhlasem Meta Pixel měří zobrazení stránek a mapových produktů pro vyhodnocení návštěv z reklam na Facebooku a Instagramu. Meta může získat technické údaje o prohlížeči a síti a ukládat cookies. Web neposílá události Purchase ani Lead. Pixel se před souhlasem nenačítá.",
