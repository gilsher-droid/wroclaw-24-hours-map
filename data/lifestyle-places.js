(function () {
  ...
  const familiarPost = "https://www.facebook.com/61591964083308/posts/122111800983398802/";
  ...
  const food = {
    ...
    polishHome: t("אוכל פולני ביתי ואותנטי. ה־placki ziemniaczane עם רוטב פטריות מזכירים לרגע לביבות מוכרות, אבל נשארים מנה פולנית לגמרי.", "Homestyle, authentic Polish food. The placki ziemniaczane with mushroom sauce may recall familiar potato pancakes, while remaining distinctly Polish.", "Domowa, autentyczna polska kuchnia. Placki ziemniaczane z sosem grzybowym mogą przywołać znajome skojarzenie, pozostając całkowicie polskim daniem.", "Hausgemachte, authentische polnische Küche. Die Kartoffelpuffer mit Pilzsauce können vertraut wirken und bleiben dabei ganz klar polnisch.", "Domácí autentická polská kuchyně. Bramboráky s houbovou omáčkou mohou působit povědomě, ale zůstávají ryze polským jídlem."),
    ...
    pretzel: t("רשת מקומית של פרצלים טריים; נשנוש נוח תוך כדי טיול, עם צורה שמרגישה מיד מוכרת.", "A local fresh-pretzel chain; an easy snack while exploring, with a shape that feels instantly familiar.", "Lokalna sieć świeżych precli; wygodna przekąska podczas spaceru, o znajomym od pierwszego spojrzenia kształcie.", "Eine lokale Kette mit frischen Brezeln; praktisch unterwegs und auf den ersten Blick vertraut.", "Místní síť čerstvých preclíků; praktická svačina při procházce s okamžitě známým tvarem."),
    ...
    market: t("שוק היסטורי עם תוצרת, קפה, אוכל פולני ומאפיות מסורתיות. בין המאפים אפשר לפעמים למצוא גם Chałka שנראית מוכרת מאוד.", "A historic market with produce, coffee, Polish food and traditional bakeries. Among the breads you may also spot chałka, with a very familiar look.", "Historyczna hala z produktami, kawą, polskim jedzeniem i tradycyjnymi piekarniami. Wśród wypieków można też wypatrzyć bardzo znajomą chałkę.", "Eine historische Markthalle mit Produkten, Kaffee, polnischem Essen und traditionellen Bäckereien. Unter den Backwaren findet man auch die vertraut wirkende Chałka.", "Historická tržnice s potravinami, kávou, polským jídlem a tradičními pekárnami. Mezi pečivem lze najít i velmi povědomou chałku."),
    jolie: t("מקום לארוחת בוקר לאורך כל היום, עם טעמים מכל העולם והנחמה המוכרת של חומוס ושקשוקה.", "A destination for all-day breakfast, with flavours from across the globe and the familiar comfort of hummus and shakshuka.", "Miejsce na śniadanie przez cały dzień, ze smakami z całego świata oraz znajomym, kojącym smakiem hummusu i szakszuki.", "Ein Ort für ganztägiges Frühstück mit Aromen aus aller Welt und dem vertrauten Genuss von Hummus und Schakschuka.", "Místo na celodenní snídani s chutěmi z celého světa a důvěrně známým potěšením z hummusu a šakšuky."),
    paczek: t("חלון מלא pączki — המאפה הפולני הקלאסי שעשוי להזכיר לרגע סופגנייה.", "A window full of pączki — the classic Polish pastry that may briefly bring a doughnut from home to mind.", "Witryna pełna pączków — klasycznego polskiego wypieku, który może przywołać znajome skojarzenie.", "Ein Schaufenster voller Pączki – das klassische polnische Gebäck, das kurz an Krapfen von zu Hause erinnern kann.", "Výloha plná pączků – klasického polského pečiva, které může na chvíli připomenout známou koblihu."),
  ...
  window.WROC_LIFESTYLE_PLACES = [
    ...
    place("chatka", ["eat"], [51.1119289,17.0313524], "Chatka przy Jatkach", food.polishHome, familiarPost, "chatka", sourceFood),
    ...
    place("pan-precel", ["eat"], [51.1069625,17.032226], "Pan Precel – Świdnicka", food.pretzel, familiarPost, null,
      t("סניף ברחוב Świdnicka; התמונות בפוסט צולמו בסניף Oławska.", "Świdnicka branch; the post photos were taken at the Oławska branch.", "Lokal przy ul. Świdnickiej; zdjęcia w poście wykonano w lokalu przy Oławskiej.", "Filiale an der Świdnicka; die Fotos im Beitrag entstanden in der Oławska-Filiale.", "Pobočka ve Świdnické ulici; fotografie v příspěvku vznikly v pobočce v Oławské ulici.")),
    place("pan-precel-olawska", ["eat"], [51.10627,17.03802], "Pan Precel – Oławska 22", food.pretzel, familiarPost, "pan-precel-olawska", sourceFood),
    place("dobra-paczkarnia-kuznicza", ["eat"], [51.10851,17.03589], "Dobra Pączkarnia – Kuźnicza 25", food.paczek, familiarPost, "dobra-paczkarnia-kuznicza", sourceFood),
