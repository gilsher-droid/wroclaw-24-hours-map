(function () {
  ...
  window.PREMIUM_STOPS = [
    ...
    stop("ossolineum",2,4,[51.11343,17.03657],"culture","12:00","25 min",false,l("Ossolineum והחצר","Ossolineum and courtyard","Ossolineum i dziedziniec"),"Ossolineum",l("שער וחצר שקטה בדרך מזרחה; ביקור קצר שאינו דורש מאמץ רב.","A quiet gate and courtyard on the way east; a short, low-effort visit.","Spokojna brama i dziedziniec po drodze na wschód; krótka, niewymagająca wizyta."),l("אם החצר סגורה, הסתפקו בחזית והמשיכו.","If the courtyard is closed, enjoy the façade and continue.","Jeśli dziedziniec jest zamknięty, zobaczcie fasadę i idźcie dalej.")),
